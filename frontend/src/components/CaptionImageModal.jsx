...
export default function CaptionImageModal({ isOpen, onClose, onGenerate, initialText = '' }) {
  return (
    <IOSModal isOpen={isOpen} onClose={onClose} className="max-w-4xl" style={{ height: '90vh', maxHeight: '90vh' }}>
      <div className="flex flex-col h-full min-h-0 max-h-full">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-base-300 bg-gradient-to-r from-primary/5 to-secondary/5 flex-shrink-0">
